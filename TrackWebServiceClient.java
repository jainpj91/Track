...
public class TrackWebServiceClient {
	...
	public static void main(String[] args) throws Exception {   
        ...
        packageIdentifier.setValue(getSystemProperty("449044304137821")); // tracking number
	...
	private static ClientDetail createClientDetail() {
        ...
        if (meterNumber == null) {
        	meterNumber = "118684270"; // Replace "XXX" with clients meter number
        }
	...
	private static WebAuthenticationDetail createWebAuthenticationDetail() {
        ...
        //
        if (key == null) {
        	key = "Dv9y3zzawS0qUoPy"; // Replace "XXX" with clients key
        }
        if (password == null) {
        	password = "xkNBYjZBozrUR7Ylf8zsrDiJK"; // Replace "XXX" with clients password
        }
        ...
        if(useParentCredential){
        	...
        	//
        	if (parentKey == null) {
        		parentKey = "Dv9y3zzawS0qUoPy"; // Replace "XXX" with clients parent key
        	}
        	if (parentPassword == null) {
        		parentPassword = "xkNBYjZBozrUR7Ylf8zsrDiJK"; // Replace "XXX" with clients parent password
        	}
